...
wget https://raw.githubusercontent.com/kypc86/proxy/master/static/squid-4.10.tar.gz
...
EOF
cd 
wget https://raw.githubusercontent.com/kypc86/proxy/master/squid/setup.sh
